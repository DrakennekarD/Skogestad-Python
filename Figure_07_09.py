...
WI_improved = WI*tf([(tmax/2.363)**2, 2*0.838*(tmax/2.363), 1],
                    [(tmax/2.363)**2, 2*0.685*(tmax/2.363), 1])
...
plt.loglog(w, np.abs(WI_improved(s)), color='lime',
           label='$improved$ $\omega_I$')
plt.legend()
